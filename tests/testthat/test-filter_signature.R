...
test_that("signature has correct rows when filtering in any direction", {
...
test_that("signature has correct rows when filtering in up direction", {
...
test_that("signature has correct rows when filtering in down direction", {
...
test_that("filtered signatures have the correct columns", {
...
test_that("signature has correct content when filtering in any direction", {
...
test_that("signature has correct content when filtering in up direction", {
...
test_that("signature has correct content when filtering in down direction", {
