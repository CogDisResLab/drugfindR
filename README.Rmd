...
Install the stable release from [r-universe](https://cogdisreslab.r-universe.dev/drugfindR):
...
- **[Getting Started](https://cogdisreslab.github.io/drugfindR/articles/getting-started.html)** - Quick start guide with common workflows
- **[Drug Repurposing from Transcriptomic Data](https://cogdisreslab.github.io/drugfindR/articles/drug-repurposing.html)** - Comprehensive guide for therapeutic discovery
- **[Target Investigation and Functional Genomics](https://cogdisreslab.github.io/drugfindR/articles/target-investigation.html)** - Gene and drug target analysis
