...
#' This has to be one of c("OE", "CP", "KD")
#' @param pairedAnalysis A logical indicating whether a [`pairedAnalysis`]
#' should be performed
...
#' @param concordanceLimitDown Lower threshold for selecting concordant
#' compounds.
#'
#' @return A `drugfindRCoreData` S4 object
#' @keywords internal
drugfindRCoreData <- function(
    coreSignature,
    inputLibrary = NULL,
    outputLibrary = NULL,
    pairedAnalysis = TRUE,
